...
contract YourContract {
  ...
  uint public contractCombBalance;
  uint public contractPairBalance;
  ...
  function swapHalfComb() external {
      ...
      console.log("combBalance: ", combBalance);
      contractCombBalance = combBalance;

      uint pairBalance = IERC20(PairToken).balanceOf(address(this));
      contractPairBalance =  pairBalance;
      console.log("pair balances", pairBalance);
      ...
      // set balances
      contractPairBalance = IERC20(CombToken).balanceOf(address(this));
      contractPairBalance = IERC20(PairToken).balanceOf(address(this));

      console.log("combBalance: ", IERC20(CombToken).balanceOf(address(this)));
      console.log("pairBalance: ", IERC20(PairToken).balanceOf(address(this)));
  }
